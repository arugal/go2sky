...
func Test_defaultSp_SetSpanLayer(t *testing.T) {
	...
	tests := []struct {
	...
	}{
		{
			...
			struct{ layer agent.SpanLayer }{layer: agent.SpanLayer_Unknown},
		},
		{
			"Set SpanLayer_Database",
			struct{ layer agent.SpanLayer }{layer: agent.SpanLayer_Database},
		},
		{
			"Set SpanLayer_RPCFramework",
			struct{ layer agent.SpanLayer }{layer: agent.SpanLayer_RPCFramework},
		},
		{
			"Set SpanLayer_Http",
			struct{ layer agent.SpanLayer }{layer: agent.SpanLayer_Http},
		},
		{
			"Set SpanLayer_MQ",
			struct{ layer agent.SpanLayer }{layer: agent.SpanLayer_MQ},
		},
		{
			"Set SpanLayer_Cache",
			struct{ layer agent.SpanLayer }{layer: agent.SpanLayer_Cache},
		},
	}
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
